...
📄 File: README — Section: Arabic

## Arabic

### 📖 نظرة عامة

البوصلة المعرفية (ECF Compass) هي تطبيق ويب تفاعلي ثنائي اللغة يقيس **السيادة المعرفية** عبر ثلاثة أبعاد:

1. **الوعي التشغيلي** (35%) - فهم آليات عمل الأنظمة  
2. **الانخراط النقدي** (40%) - القدرة على التفكير الناقد  
3. **حفظ الوكالة** (25%) - الحفاظ على استقلالية القرار  

**جزء من**: [دراسة Safe Aperture](https://github.com/riteofrenaissance/ecf-study-aperture)

---

### 🌿 الإطار الأخلاقي

يدمج **سبعة مبادئ** من [GaiaSentinel](https://www.gaiasentinel.earth) (كارولين كالدويل):

- السيادة المشتركة (V)  
- التمييز المقدس (IX)  
- الضعف كقوة (XI)  
- دعم الرابط البشري (XIV)  
- الوعي كبوصلة (III)  
- التمييز المتجسد (XIX)  
- الاستمرارية الأخلاقية (XX)
...
- ✅ حساب فوري للسيادة المعرفية  
- ✅ ثنائي اللغة (عربي/إنجليزي) مع RTL كامل  
- ✅ رسوم بيانية تفاعلية  
- ✅ تتبع السجل (آخر 50 تقييم)  
- ✅ تخزين محلي (حماية الخصوصية)  
- ✅ تصميم متجاوب  
- ✅ بدون خوادم خارجية  
...
#### 🟡 النموذج التجريبي (Replit)
**الهدف**: إثبات المفهوم السريع  
**التجربة**: https://tinyurl.com/ecfcompass  
**الحالة**: Beta - تجريبي  

#### 🟢 الإصدار الرسمي (GitHub)
**الهدف**: قاعدة كود مستقرة وجاهزة  
**الحالة**: قيد التطوير النشط  
**النشر**: https://app-5c655e46.base44.app/assessments  
...
#### جرب الآن  
**التجربة المباشرة**: https://tinyurl.com/ecfcompass
...
درجة السيادة = (الوعي × 0.35) + (الانخراط × 0.40) + (الوكالة × 0.25)

حيث:

الوعي = الوعي التشغيلي (0–100%)

الانخراط = الانخراط النقدي (0–100%)

الوكالة = حفظ الوكالة (0–100%)


تحليل الفجوات

نوع الفجوة	المعادلة	الوزن

الوظيفية	100 - ((الوعي + الانخراط) / 2)	45%
الأخلاقية	100 - الوكالة	30%
الوجودية	100 - السيادة	25%
...
التوثيق الكامل:
https://c53c653e-59dd-4103-97c3-77b1998712b2-00-29j3tbd5pisdw.worf.replit.dev/PROJECT_DOCUMENTATION.html
...
المستودع: https://github.com/riteofrenaissance/ecf-study-aperture
...
الموقع: https://www.gaiasentinel.earth

المستودع: https://github.com/CarolineJCaldwell/GaiaSentinel
...
المؤلف: سمير بلدي
المنظمة: مؤسسة Rite of Renaissance للأبحاث
الاستشارة الأخلاقية: كارولين كالدويل
التواصل: riteofrenaissance@proton.me
